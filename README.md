...
- [ ] 캐러셀 콘텐츠 만들기
- [x] 페이지 하단영역
- [X] 메인 콘텐츠 : 데스크탑 버전일때 레이아웃 잡기
- [ ] 메인 콘텐츠 : 영화 콘텐츠 부분 상세 콘텐츠 내용 채우고 스타일링
- [ ] 메인 콘텐츠 : 반응형 대응 하기
...
- [ 문제점 2 ]
  + 흠,,, 태블릿 까진 괘찮은데 모바일이 문제다. ==> 아무래도 그냥 일반적인 콘텐츠 형식으로 보여줘야할 것 같다!!!  데탑, 태블릿만 저런 레이아웃의 형태를 가지고 모바일은 일반적으로,,
- [ 해결방법 2 ]
